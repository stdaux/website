                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-12 col-md-7 col-lg mg-t-20 mg-sm-t-0 mg-lg-t-25">
                                    ...
                                    <div className="d-flex mg-b-25">
                                        <button className="btn btn-xs btn-white flex-fill" onClick={() => setProfileFormShow(true)}>Edit Profile</button>
                                        <button className="btn btn-xs btn-primary flex-fill mg-l-10" onClick={() => setPasswordChangeFormShow(true)}>Password</button>
                                    </div>
                                </div>
                                <div className="col-sm-12 col-md-12 col-lg mg-t-40">
                                    ...
                                    <ul className="list-unstyled profile-info-list">
                                        ...
                                        {user.date_of_birth && 
                                        <li><FiGift/> <a href="">{user? moment(user.date_of_birth).format("MMMM DD, YYYY"):''}</a></li>
                                        }
                                    </ul>
                                </div>
                            </div>
