...
const ListSupport = (props) => {
    const {className} = props;
    const [supportRequests, setSupportRequests] = useState([]);
    const router = useRouter();
    const { redirect_from } = router.query;

    useEffect(() => {
        const listSupportURL = HelpUrls.listSupport;
        const token = getUserToken();
        axios.get(listSupportURL, {
            headers: {
        ...
        <>  
            ...
            <div className="row row-xs">
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div className="ht-50 bd d-flex rounded wd-100p">
                        <div className="d-flex align-items-center pd-x-20 wd-100p">
                            ...
                            <AsyncTypeahead
                                ...
                                placeholder="Search for Support Issues..."
